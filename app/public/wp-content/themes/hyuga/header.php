...
<meta name="google-site-verification" content="X8DsbhJ7Jq55EaXEx9bpnL0azWb__nKB4Hx0F8z9vbg" />
    ...
    <title><?php if ( is_home() ) :?>WAYX（ウェイクス）FITNESS GYM 日向店<?php else : ?><?php the_title(); ?> | WAYX（ウェイクス）FITNESS GYM 日向店<?php endif; ?></title>
    ...
    })(window,document,'script','dataLayer','GTM-T7QR7PNN');</script>
    <!-- End Google Tag Manager -->

    <!--  SEO 設定  -->
    <meta name="description" content="日向市財光寺、国道10号沿いにある海の家をイメージした、明るい店内の24時間営業フィットネスジム。トレーニング効果が高く、初心者でも安心設計のマシン。プレートローデッドを大量導入。充実！のフリーウエイト。暗闇バーチャルスタジオは、世界45ヶ国で導入されているフィットネススタジオプログラム「ラディカル バーチャル」を日向市初導入！多彩なプログラムを壁一面の大画面で24時間お楽しみ頂けます。">
    ...
    <meta property="og:description" content="日向市財光寺、国道10号沿いにある海の家をイメージした、明るい店内の24時間営業フィットネスジム。トレーニング効果が高く、初心者でも安心設計のマシン。プレートローデッドを大量導入。充実！のフリーウエイト。暗闇バーチャルスタジオは、世界45ヶ国で導入されているフィットネススタジオプログラム「ラディカル バーチャル」を日向市初導入！多彩なプログラムを壁一面の大画面で24時間お楽しみ頂けます。">
...
<?php else : ?>
        <p class="site-header__logo"><a href="<?php echo home_url('/'); ?>"><img src="https://wayx.jp/wp-content/themes/WAYX-theme/images/logo-1.png" alt="WAYX 入会"></a></p>
<?php endif; ?>
        <ul class="site-header__sns">
            <li><a href="https://www.instagram.com/fitnessgym_wayx_hyuga/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/logo_in.svg" alt=""></a></li>
            <li><a href="https://www.facebook.com/profile.php?id=61572998266152" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/logo_fb.svg" alt=""></a></li>
            <li><a href="https://www.youtube.com/@fitnessgym_wayx_hyuga" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/logo_yt.svg" alt=""></a></li>
        </ul>
